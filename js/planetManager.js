    ...
    initializePlanets() {
        return [
            ...
            },
            {
                ...
                moons: [{ name: 'Moon', size: 2.5, distance: 18, speed: 0.05, color: {r: 200, g: 200, b: 200} }],
        ...
        this.planets.forEach(planet => {
            ...
            if (planet.moons) {
                planet.moons.forEach(moon => {
                    moon.angle = (moon.angle || 0) + moon.speed * speed * 4;
                });
            }
        });
    }
    ...
    addCustomPlanet(config) {
        ...
        const newPlanet = {
            ...
            info: {
                ...
                description: config.description || 'Custom Planet'
            },
            isCustom: true
        };
